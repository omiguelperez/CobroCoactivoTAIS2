namespace DAL.Migrations
{
    ...
    public partial class PaisDepartamentoMunicipioSprint3 : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .ForeignKey("dbo.TipoCobroes", t => t.TipoCobroId)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Expedientes", t => t.ExpedienteId)
                .ForeignKey("dbo.Personas", t => t.PersonaId)
                .ForeignKey("dbo.TipoObligacions", t => t.TipoObligacionId)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.TipoPersonas", t => t.TipoPersonaId)
